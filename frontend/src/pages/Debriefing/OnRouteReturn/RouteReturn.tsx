...
const RouteReturn = () => {
  ...
  const columns = [
    {
      ...
      render: (text: string, record: any) => {
        return <Link to={`/view-return/${record._id}`}>#{text}</Link>;
      },
    },
  ...
  return (
    <>
      <PageMeta title="Mayl Logistics" description="On Route Return" />
      <PageBreadcrumb pageTitle="On Route Return" />
